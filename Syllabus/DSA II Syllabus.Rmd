---
title: "CSCI 4153 - Data Structures and Algorithms II"
...
This course builds on the foundations of Data Structures and Algorithms I, focusing on advanced data structures and algorithmic strategies. Students will explore balanced trees, advanced graph algorithms, and sophisticated sorting and searching techniques. Core algorithm design paradigms such as divide-and-conquer, greedy algorithms, and dynamic programming are studied in depth, alongside applications in optimization and problem solving. Topics also include advanced hash tables, tries, and non-comparison-based sorting algorithms. Emphasis is placed on analyzing algorithmic efficiency, understanding trade-offs in design, and applying advanced methods to complex computational problems. By the end of the course, students will be able to design, analyze, and implement efficient algorithms for a wide range of applications. (3 hours)  

**Prerequisite:** CSCI 3141 - Data Structures and Algorithms I
...
- **Balanced Trees:** AVL trees, Red-Black trees, Tries  
- **Advanced Sorting:** Heap sort, Counting sort, Radix sort, Bucket sort  
- **Graph Algorithms:** Dijkstra’s, Prim’s, Kruskal’s, Bellman-Ford, Floyd-Warshall  
- **Algorithmic Paradigms:** Divide-and-conquer, Greedy algorithms, Dynamic programming  
